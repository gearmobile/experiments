...
const regionRegistrationData = [
  ...
  [
    ...
    { name: 'Ливны, Мценск', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.7 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    { name: 'Пенза', value: 1, ratio: 1.4 },
    { name: 'Заречный', value: 1, ratio: 1.2 },
    { name: 'Кузнецк', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.7 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    ...
    { name: 'Лысьва, Чайковский', value: 3, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 5, ratio: 1.1 },
  ],
  // -------------
  [
  ...
  [
    ...
    { name: 'Великие Луки', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.7 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    { name: 'прочие города и населенные пункты', value: 5, ratio: 1.3 },
  ],
  // -------------
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Стерлитамак, Туймазы', value: 1, ratio: 1.3 },
    { name: 'Благовещенск, Октябрьский', value: 1, ratio: 1.2 },
    { name: 'Ишимбай, Кумертау, Салават', value: 1, ratio: 1.1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 1 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Назрань', value: 1, ratio: 0.6 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.6 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Рузаевка', value: 1, ratio: 1.2 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.8 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    { name: 'Якутск', value: 1, ratio: 1.2 },
    { name: 'Нерюнгри', value: 1, ratio: 0.8 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.6 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Набережные Челны', value: 1, ratio: 1.7 },
    { name: 'Альметьевск, Зеленодольск, Нижнекамск', value: 1, ratio: 1.3 },
    { name: 'Елабуга', value: 1, ratio: 1.2 },
    { name: 'Бугульма, Лениногорск, Чистополь', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 1.1 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Батайск', value: 1, ratio: 1.3 },
    { name: 'Азов', value: 1, ratio: 1.2 },
    { name: 'Шахты', value: 1, ratio: 1.1 },
    { name: 'Волгодонск, Гуково, Каменск-Шахтинский, Новочеркасск, Новошахтинск, Сальск, Таганрог', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.8 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Новокуйбышевск, Сызрань', value: 3, ratio: 1.1 },
    { name: 'прочие города и населенные пункты', value: 5, ratio: 0.9 },
  ],
  // -------------
  [
  ...
  [
    ...
    { name: 'Энгельс', value: 1, ratio: 1.2 },
    { name: 'Балаково, Балашов, Вольск', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.7 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Березовский, Верхняя Пышма, Новоуральск, Первоуральск', value: 1, ratio: 1.3 },
    { name: 'Верхняя Салда, Полевской', value: 1, ratio: 1.2 },
    { name: 'Асбест, Ревда', value: 1, ratio: 1.1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 1 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    { name: 'Смоленск', value: 1, ratio: 1.2 },
    { name: 'Вязьма, Рославль, Сафоново, Ярцево', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.7 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Мичуринск', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.8 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    { name: 'Тверь', value: 1, ratio: 1.5 },
    { name: 'Вышний Волочек, Кимры, Ржев', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.8 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Узловая, Щекино', value: 1, ratio: 1.2 },
    { name: 'Алексин, Ефремов, Новомосковск', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.9 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    { name: 'Тюмень', value: 1, ratio: 2 },
    { name: 'Тобольск', value: 1, ratio: 1.3 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 1.1 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Димитровград', value: 1, ratio: 1.2 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.9 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    { name: 'Хабаровск', value: 1, ratio: 1.7 },
    { name: 'Комсомольск-на-Амуре', value: 1, ratio: 1.3 },
    { name: 'Амурск', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.8 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
    ...
    { name: 'Нефтеюганск, Нягань', value: 3, ratio: 1.3 },
    { name: 'Когалым', value: 3, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 5, ratio: 1.1 },
  ],
  // -------------
  [
    ...
    { name: 'Магнитогорск', value: 1, ratio: 1.8 },
    { name: 'Копейск', value: 1, ratio: 1.6 },
    { name: 'Златоуст, Миасс', value: 1, ratio: 1.4 },
    { name: 'Сатка, Чебаркуль', value: 1, ratio: 1.2 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 1 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
  ...
  [
    ...
    { name: 'Новочебоксарск', value: 1, ratio: 1.2 },
    { name: 'Канаш', value: 1, ratio: 1.1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 0.8 },
  ],
  // -------------
  [
  ...
  [
    ...
    { name: 'Новый Уренгой', value: 1, ratio: 1 },
    { name: 'прочие города и населенные пункты', value: 2, ratio: 1.1 },
  ],
  [
    { name: 'не выбран', value: 0, ratio: 0 },
