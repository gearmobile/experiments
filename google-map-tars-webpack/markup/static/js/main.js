...
GoogleMapsLoader.load( function (google) {
    ...
    const brampton = document.getElementById('googleMap');
    ...
    const markerPath = ( isIE11 ) ? 'static/img/assets/google/icon-location.png' : 'static/img/assets/google/icon-location.svg';
